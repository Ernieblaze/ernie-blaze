      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {topics.map(({ title, description, Icon, bg }, i) => (
          <Reveal key={title} delay={i * 80}>
            <div className="h-full rounded-2xl border border-ink/8 bg-white p-6 sm:p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_-16px_rgba(16,185,129,0.25)] hover:border-emerald/30">
